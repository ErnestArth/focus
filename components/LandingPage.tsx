/**
 * v0 by Vercel.
 * @see https://v0.dev/t/X6Ek4koNA0V
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                    <TruckIcon className="h-6 w-6 mr-2 inline-block" />
                    Prevent Driver Fatigue, Protect Your Fleet
                  </h1>
                  <p className="max-w-[600px] text-primary-foreground/80 md:text-xl">
                    Our advanced driver fatigue monitoring system helps transport agencies identify and address
                    fatigue-related risks, keeping drivers safe and your operations efficient.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  <ActivityIcon className="h-6 w-6 mr-2 inline-block" />
                  Fatigue Insights for Drivers
                </h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Our driver fatigue monitoring system provides real-time insights to help drivers understand their
                  fatigue levels and take proactive measures to stay alert and safe on the road.
                </p>
              </div>
            </div>
                ...
                <ul className="grid gap-6">
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground">
                        Our system tracks driver fatigue levels in real-time, providing timely alerts to help drivers
                        stay safe.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground">
                        Drivers can view their fatigue history and trends to better understand their sleep patterns and
                        driving habits.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground">
                        Get personalized recommendations to help drivers manage fatigue and stay alert on the road.
                      </p>
                    </div>
                  </li>
                </ul>
          ...
          <div  className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-secondary-foreground/80 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                ...
                identify and address risks, ensuring the safety of their drivers and fleet.
              </p>
            </div>
          ...
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Our platform provides real-time insights and proactive recommendations to help transport agencies and
                drivers manage fatigue-related risks.
              </p>
            </div>
            <div className="mx-auto w-full max-w-sm space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                <Link href="#" className="underline underline-offset-2 text-secondary" prefetch={false}>
                  Terms &amp; Conditions
                </Link>
              </p>
            </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t bg-muted text-muted-foreground">
        ...
        <nav className="sm:ml-auto flex gap-4 sm:gap-6">
          <Link href="#" className="text-xs hover:underline underline-offset-4 text-secondary" prefetch={false}>
            <ShieldIcon className="h-4 w-4 mr-2 inline-block" />
            Privacy
          </Link>
          <Link href="#" className="text-xs hover:underline underline-offset-4 text-secondary" prefetch={false}>
            <FileTextIcon className="h-4 w-4 mr-2 inline-block" />
            Terms of Service
          </Link>
        </nav>
      </footer>
